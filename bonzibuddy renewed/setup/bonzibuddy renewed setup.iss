...
[Files]
Source: "C:\Documents and Settings\williamtylertv\Desktop\Copy of BonziBuddy_RENEWED-main COMPILED\bonzibuddy renewed\src\*"; DestDir: "{app}";
Source: "C:\Documents and Settings\williamtylertv\Desktop\Copy of BonziBuddy_RENEWED-main COMPILED\bonzibuddy renewed\src\install dependencies\install dependencies.bat"; DestDir: "{app}\install dependencies";
...
Source: "C:\Documents and Settings\williamtylertv\Desktop\Copy of BonziBuddy_RENEWED-main COMPILED\bonzibuddy renewed\src\install dependencies\spchapi.exe"; DestDir: "{tmp}"; Flags: deleteafterinstall
Source: "C:\Documents and Settings\williamtylertv\Desktop\Copy of BonziBuddy_RENEWED-main COMPILED\bonzibuddy renewed\src\install dependencies\tv_enua.exe"; DestDir: "{tmp}"; Flags: deleteafterinstall
